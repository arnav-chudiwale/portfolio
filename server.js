...
app.use((req, res, next) => {
  ...
  res.setHeader('Content-Security-Policy',
    "default-src 'self'; " +
    "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://*.arcgis.com https://cdn.jsdelivr.net https://code.jquery.com https://cdnjs.cloudflare.com; " +
    "style-src 'self' 'unsafe-inline' https://api.fontshare.com https://*.arcgis.com https://cdn.jsdelivr.net https://netdna.bootstrapcdn.com https://cdnjs.cloudflare.com; " +
    "font-src 'self' https://cdn.fontshare.com https://*.arcgis.com https://cdn.jsdelivr.net https://netdna.bootstrapcdn.com https://cdnjs.cloudflare.com; " +
    "img-src 'self' data: blob: https://tile.openstreetmap.org https://*.arcgis.com https://*.arcgisonline.com https://cdn.jsdelivr.net https://cdnjs.cloudflare.com; " +
    "media-src 'self'; " +
